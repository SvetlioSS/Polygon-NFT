 ...
 */
contract FxLimeGameItemRootTunnel is FxBaseRootTunnel, IERC721Receiver {
    ...
    function deposit(
        ...
        emit TestMessage('Before encode');
        ...
        emit TestMessage('After encode');
        _sendMessageToChild(message);
        emit TestMessage('After message send');
